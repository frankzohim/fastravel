...
import 'ride_search_result.dart';
              ...
              child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        'Entrer un départ et une destination',
                              ...
                              Container(
                                ...
                                child: ElevatedButton(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text('Rechercher'.toUpperCase(), style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white),),
                                  ),
                                  onPressed: (){
                                    ...
                                    if (_formKey.currentState!.validate()) {
                                      ...
                                      /*_login();*/
                                      Navigator.push(context, MaterialPageRoute(builder: (context) => RideSearchResultPage()),);
                                    }
                                  },
                                ),
                              ),
